 ...
 */
package com.test.test2app.threadpool;
...
/**
 * https://github.com/yjfnypeu/EasyThread.git
 */
public final class EasyThread implements Executor {
    ...
    public static class Builder {
        ...
        public EasyThread build () {
            priority = Math.max(java.lang.Thread.MIN_PRIORITY, priority);
            priority = Math.min(java.lang.Thread.MAX_PRIORITY, priority);
