...
package com.test.test2app.bitmap;
...
public class LruCache<K, V> {
    ...
    public synchronized final V put(K key, V value) {
        ...
        S.s("size:"+size+" maxSize:"+maxSize);
        trimToSize(maxSize);
        S.s("map.size:"+map.size());
        return previous;
    }
    ...
    private synchronized int safeSizeOf(K key, V value) {
     ...
     */
    protected synchronized int sizeOf(K key, V value) {
        return 1;
    }
